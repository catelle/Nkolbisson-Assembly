        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              onChange={(event) => setCurrent({ ...current, subtitle: { ...current.subtitle, fr: event.target.value } })}
              className="mt-2 w-full rounded-2xl border border-white/10 bg-sky-900 px-3 py-2 text-sm text-white"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(event) => setCurrent({ ...current, subtitle: { ...current.subtitle, en: event.target.value } })}
              className="mt-2 w-full rounded-2xl border border-white/10 bg-sky-900 px-3 py-2 text-sm text-white"
            />
          </div>
          <div>
      ...
      <div className="rounded-3xl border border-white/10 bg-sky-900/60 p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              type="button"
              onClick={() => setCurrent((prev) => ({ ...prev, blocks: [...prev.blocks, createBlock(newBlockType)] }))}
